...
{
    class QuitForm: System.Windows.Forms.Form
    {
        ...
        public QuitForm()
        {
            ...
            float scaleConst = this.getWndScaling();
            ResizeWnd(scaleConst);
            this.Opacity = 0;
        }

        public float getWndScaling()
        {
            int dpiX;
        ...
        public QuitForm(int FatherWndX, int FatherWndY)
        {
            InitializeComponent();
            ResizeWnd();
            this.Opacity = 0;
            this.Location = new System.Drawing.Point(FatherWndX + MainFrmSize.FormWidth / 2 - 415 / 2, FatherWndY + MainFrmSize.FormHeight / 2 - 237 / 2);
        }
        ...
        private void ResizeWnd(float scaleConst)
        {
            float size = label1.Font.Size;
            this.label1.Font = new Font(label1.Font.Name, label1.Font.Size / scaleConst, label1.Font.Style);
            size = label2.Font.Size;
            this.label2.Font = new Font(label2.Font.Name, label2.Font.Size / scaleConst, label2.Font.Style);
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.pictureBox2.Location = new System.Drawing.Point(235, 165);
            ...
            // QuitForm
            // 
            this.BackgroundImage = global::求是五子棋___Gomoku_at_ZJU.Properties.Resources.Quit;
